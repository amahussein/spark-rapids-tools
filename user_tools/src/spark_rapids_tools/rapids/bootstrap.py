...
from spark_rapids_tools.cloud_api.sp_types import ClusterBase, NodeHWInfo
from spark_rapids_tools.common.sys_storage import LocalFS
from spark_rapids_tools.rapids.rapids_tool import RapidsTool
...
class Bootstrap(RapidsTool):
    ...
    def _run_rapids_tool(self):
        ...
        exec_cluster: ClusterBase = self.ctxt.get_ctxt('exec_cluster')
    ...
    def _process_output(self):
        ...
        if tool_result is not None and any(tool_result):
            ...
            LocalFS.make_dirs(self.ctxt.get_wrapper_local_output(), exist_ok=True)
