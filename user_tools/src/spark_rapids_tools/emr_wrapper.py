...
"""Wrapper class to run tools associated with RAPIDS Accelerator for Apache Spark plugin on EMR."""
...
class EMRWrapper:
    """
    A wrapper script to run Rapids tools (Qualification, Profiling, and Bootstrap) tools on Amazon EMR.
    Disclaimer:
    ...
    :profiling args
    :bootstrap args
    spark_rapids_emr qualification *args

    For more details on each command: run qualification --help
    """
    def __init__(self):
        self.__platform_type = CloudPlatform.EMR
